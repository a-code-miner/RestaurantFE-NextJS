...
const Header = () => {
    return (
        <div className="relative flex flex-col items-center justify-center min-h-[800px] sm:h-[300px] bg-[url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80')] bg-no-repeat bg-cover bg-left-bottom text-white overflow-hidden">
            ...
            <div className='header bg-white/10 backdrop-blur-md p-4 md:p-10 rounded-2xl overflow-hidden shadow-sm w-[95vw] max-w-2xl mx-auto'>
                <div className="relative z-10 flex flex-col items-center">
                    <h1 className="text-2xl md:text-5xl font-bold mb-4 text-center">به رستوران پالمیر خوش آمدید!</h1>
